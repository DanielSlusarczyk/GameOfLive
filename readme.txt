...
W szczególnym przypadku błędu FILENAME_TAKEN, jeżeli podana nazwa pliku wynikowego będzie pokrywać się z nazwą pliku wejściowego, przed zwróceniem kodu błędu i zakończeniem działania programu, użytkownik zostanie zapytany, czy plik ma zostać nadpisany w wejściu, aby nie było konieczne uruchamiania programu od nowa, z flagą "-ovw"